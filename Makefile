...
#Boss automated testing
Boss_automated_testing: Attribute.o Monster.o Species.o Boss.o Boss_automated_testing.cpp add_on_func.cpp
	g++ Attribute.o Monster.o Species.o Boss.o Boss_automated_testing.cpp add_on_func.cpp -o Boss_automated_testing
	./Boss_automated_testing < input_Boss_automated_testing.txt | diff - expected_Boss_automated_testing.txt
...
clean:
	...
	rm -f Item_automated_testing Zone_automated_testing Attribute_automated_testing Boss_automated_testing